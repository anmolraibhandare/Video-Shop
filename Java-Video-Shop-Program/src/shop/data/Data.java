...
public class Data {
	...
	static HashMap<Integer,Video> vid = new HashMap<Integer,Video>();
		private Data() {}
  /**
   ...
   */
    ...
    // TODO
			if((title == null) || (title.equals("")) || (title.equals(" ")) || (director == null) || (year <= 1800) || (year >= 5000) || (director.equals("")) || (director.equals(" "))) {
				throw new IllegalArgumentException();
			}
			title = title.trim();
			director = director.trim();

			Video value = new VideoObj(title, year, director);
			if(vid.containsValue(value)) {
				return vid.get(value.hashCode());
			} else {
				vid.put(value.hashCode(), value);
				return vid.get(value.hashCode()); }
		}
